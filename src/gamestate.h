...
struct CharacterState
{
    ...
    // alphatest -- extended character state
...
extern int64 Rpg_WeightedPopulationCount[RPG_NPCROLE_MAX];
...
extern int64 Rpg_WeightedMonsterCount;
...
extern int64 Rpg_TeamBalanceCount[RPG_NUM_TEAM_COLORS];
...
#define RPG_BLOCKS_SINCE_MONSTERAPOCALYPSE(H) ((Cache_min_version >= 2020800) ? H - Cache_timeslot_start : H % Cache_timeslot_duration)
